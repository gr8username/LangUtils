...
SIMPLY_ERROR_MSG = "Error accessing SimplyTranslate. Most likely SimplyTranslate is down, or you do not have an Internet connection."
...
class translate_gui_gen(aqt.QDialog):
    ...
    def addLanguageSelector(self, layout) -> None:
    ...
    def dict_entry_event(self):
        ...
        if examples is None:
            showWarning("Error accessing Reverso context. Reverso may be down, or you may not have an Internet connection.")
            return
    ...
    def onButtonPress(self):
        ...
        if second_editor_data is None:
            showWarning(SIMPLY_ERROR_MSG)
            return
