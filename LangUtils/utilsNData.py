...
class VariableReference:  # Python does not make copies of classes, making them (in effect) pass by reference variables
    # So this is used to allow an async task to modify the contents of a variable
